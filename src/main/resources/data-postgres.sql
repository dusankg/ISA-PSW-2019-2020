...
insert into examination (date, price, type_id, clinic_id, doctor_id, patient_id, start_time, end_time, operation, accepted) values ('2020-02-01', 1500, 1, 1, 1, 4, 7, 8, true, false);
